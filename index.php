      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="service-panel">
              <div class="service--img">
                <img src="assets/images/services/4.png" alt="img" />
              </div>
              <h3>Haircut Styles</h3>
              <p>
                Duis aute irure dolor in reprehenderit in volupte velit esse
          ...
          <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="service-panel">
              <div class="service--img">
                <img src="assets/images/services/5.png" alt="img" />
              </div>
              <h3>Beard Trim</h3>
              <p>
                Duis aute irure dolor in reprehenderit in volupte velit esse
          ...
          <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="service-panel">
              <div class="service--img">
                <img src="assets/images/services/6.png" alt="img" />
              </div>
              <h3>Hot Shave</h3>
              <p>
                Duis aute irure dolor in reprehenderit in volupte velit esse
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div id="testimonial-carousel" class="carousel carousel-dots carousel-white" data-slide="3"
              data-slide-rs="1" data-autoplay="false" data-nav="false" data-dots="true" data-space="30" data-loop="true"
              data-speed="800">
              <!-- Testimonial #1 -->
...
============================================= -->
    <section id="clients1" class="clients clients-carousel clients-carousel-1 bg-gray">
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="carousel carousel-dots" data-slide="5" data-slide-rs="2" data-autoplay="true" data-nav="false"
