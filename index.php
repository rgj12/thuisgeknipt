...
<script type="text/javascript">
    ...
    (function () {
        ...
        s1.async = true;
        s1.src = 'https://embed.tawk.to/5e8735bb35bcbb0c9aad69ce/default';
        s1.charset = 'UTF-8';
                ...
                <div class="bottom-bar-border">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 top--info text-right text-center-xs">
                                <span class="top--login"><i class="lnr lnr-exit"></i><a href="#">Login</a> /
                                    <a href="#">Register</a></span>
                            <span class="top--social">
                                    <a class="facebook" href="https://www.facebook.com/joel.sophia.1"><i
                                                class="fa fa-facebook"></i></a>
                                    <a class="instagram" href="https://www.instagram.com/thuisgeknipt.nl/"><i
                ...
                <div class="">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="logo" href="index-2.html">
                            <img class="logo-light" src="assets/images/logo/TGP_wit.png" width="99px" height="45px"
                                 alt="Hairy Logo"/>
                            <img class="logo-dark" src="assets/images/logo/TGP_wit.png" width="99px" height="45px"
                                 alt="Hairy Logo"/>
                        </a>
                    </div>
                        ...
                        <ul class="nav navbar-nav nav-pos-right nav-bordered-right snavbar-left">
                            ...
                            <!-- <li class="has-dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="elements-columns-grids.html">grid system</a>
                                    </li>
                            ...
                            <!-- <li class="has-dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="gallery-single-images.html">single images</a>
                                    </li>
                                    <li>
                            ...
                            <div class="module-content module-box cart-box">
                                <div class="cart-overview">
                                    <ul class="list-unstyled">
                                        <li>
                                            <a href="#">
                                                <img class="img-responsive" src="assets/images/shop/thumb/1.jpg"
                                                    alt="product" />
                                            </a>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="img-responsive" src="assets/images/shop/thumb/2.jpg"
                                                    alt="product" />
                                            </a>
                                            <div class="product-meta">
                                                <h5 class="product-title">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="img-responsive" src="assets/images/shop/thumb/3.jpg"
                                                    alt="product" />
                                            </a>
                                            <div class="product-meta">
                                                <h5 class="product-title">
                                                    <a href="#">Beard Razor</a>
                                                </h5>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 text--center">
                            <div class="slide--bio">
                                De beste knipbeurten voor de voordeligste prijzen.
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
                    <div class="heading text--center mb-80">
                        <h2 class="heading--title">Wat doen wij?</h2>
                        <p class="heading--desc">
                            Wij leveren services aan iedereen. Mannen en vrouwen van alle leeftijden! Alleen op
                            afspraak!
                        </p>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <div class="service-panel">
                        <div class="service--img">
                            <img src="assets/images/services/f1.jpg" alt="img"/>
                        </div>
                        <h3>Knippen/baard trimmen</h3>
                        <p>
                            Knippen incl. baard en snor
                    </div>
                    <!-- .container end -->
                </div>
                <!-- .col-md-4 end -->
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <div class="service-panel">
                        <div class="service--img">
                            <img src="assets/images/services/f2.jpg" alt="img"/>
                        </div>
                        <h3>Gezichtsbehandelingen</h3>
                        <p>
                            Waaronder wenkbrauwen epileren
                        </p>
                    </div>
                    <!-- .container end -->
                </div>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <div class="service-panel">
                        <div class="service--img">
                            <img src="assets/images/services/f3.jpg" alt="img"/>
                        </div>
                        <h3>Ook kinderen!</h3>
                        <p>
                            Kinderen tot twaalf jaar genieten van een voordelige prijs
                        </p>
                    </div>
                    <!-- .container end -->
                </div>
...
============================================= -->
    ...
    <!-- <div class="testimonial--body">
                                <p>
                                    ...
                                    sollidin, lorem quis bibendum auctor nisi elit.”
                                </p>
                            </div> -->
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="carousel carousel-dots" data-slide="5" data-slide-rs="2" data-autoplay="true"
                        ...
                        <!-- Client #5 -->
                        <div class="client">
                            <img class="center-block" src="assets/images/clients/1.png" style="height: 70px;"
                                 alt="client"/>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="#" method="post" id="afspraak_form" autocomplete="off">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="price0" name="prijs" readonly>
                            </div>
                    ...
                    <div class="form-group">
                        <label for="opmerking">Vul eventueel uw adres in</label>
